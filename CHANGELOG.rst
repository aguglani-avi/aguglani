...
- Most models are now registered using the submodel feature from Aguglani-core
- Added an analytical model for fuselage mass estimation
- Dependencies were updated to reflected the separation between core and models in Aguglani
...
- Use of the mission builder feature in Aguglani-GA is now possible
