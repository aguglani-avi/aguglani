...
from Aguglani.command import api
from Aguglani.command.unitary_tests.dummy_classes import Disc1, Disc2, Disc3
from Aguglani import models
from Aguglani.models import (
    aerodynamics,
    geometry,
    handling_qualities,
    load_analysis,
...
from Aguglani.models.weight import cg, mass_breakdown
...
def test_id_working():
    ...
    configurator = oad.AguglaniProblemConfigurator(pth.join(DATA_FOLDER_PATH, "blank.yml"))
