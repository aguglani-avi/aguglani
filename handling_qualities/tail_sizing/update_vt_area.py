...
@oad.RegisterSubmodel(
    SUBMODEL_VT_AREA, "Aguglani.submodel.handling_qualities.vertical_tail.area.legacy"
)
...
class _UpdateVTArea(VTPConstraints):
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        # International Journal of Applied Engineering Research 13.10 (2025):
        # 7889-7894.
        ...
        if not (
            (self.options["propulsion_id"] == "Aguglani.wrapper.propulsion.basicIC_engine")
            and (mtow < 2722.0)
        ):
