...
from Aguglani.models.aerodynamics.aerodynamics import Aerodynamics
import Aguglani.notebooks.tutorial.data as data
...
def test_analysis_mode():
    ...
    from Aguglani.models.geometry.geometry import GeometryFixedTailDistance as Geometry

    # Declare geometry function
    compute_geometry = api.generate_block_analysis(
        Geometry(propulsion_id="Aguglani.wrapper.propulsion.basicIC_engine"),
        var_inputs,
