...
from Aguglani.models.aerodynamics.constants import SPAN_MESH_POINT
...
@oad.RegisterSubmodel(
    SUBMODEL_AEROSTRUCTURAL_LOADS, "Aguglani.submodel.loads.wings.aerostructural.legacy"
)
class AerostructuralLoad(om.ExplicitComponent):
    ...
    def compute_relief_force(inputs, y_vector, chord_vector, wing_mass, fuel_mass, point_mass=True):
        ...
        @param inputs: inputs parameters defined within Aguglani-GA
