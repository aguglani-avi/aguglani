...
def test_advanced_cl():
    ...
    inputs_list = list_inputs(
        UpdateWingAreaLiftEquilibrium(propulsion_id="Aguglani.wrapper.propulsion.basicIC_engine")
    )
    ...
    inputs_list = list_inputs(
        ConstraintWingAreaLiftEquilibrium(propulsion_id="Aguglani.wrapper.propulsion.basicIC_engine")
    )
