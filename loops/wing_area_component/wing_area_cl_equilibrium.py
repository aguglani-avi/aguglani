...
from Aguglani.constants import EngineSetting
from Aguglani.openmdao.problem import AutoUnitsDefaultGroup
from scipy.constants import g

from Aguglani.command.api import list_inputs_metadata
from Aguglani.models.performances.mission_vector.constants import SUBMODEL_EQUILIBRIUM
from Aguglani.models.performances.mission_vector.mission.dep_equilibrium import (
    DEPEquilibrium,
)
...
@oad.RegisterSubmodel(
    SUBMODEL_WING_AREA_AERO_LOOP, "Aguglani.submodel.loop.wing_area.update.aero.equilibrium"
)
...
@oad.RegisterSubmodel(
    SUBMODEL_WING_AREA_AERO_CONS, "Aguglani.submodel.loop.wing_area.constraint.aero.equilibrium"
)
