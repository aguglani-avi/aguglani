...
oad.RegisterSubmodel.active_models[SUBMODEL_WING_AREA_AERO_LOOP] = (
    "Aguglani.submodel.loop.wing_area.update.aero.simple"
)
oad.RegisterSubmodel.active_models[SUBMODEL_WING_AREA_AERO_CONS] = (
    "Aguglani.submodel.loop.wing_area.constraint.aero.simple"
)


@oad.RegisterSubmodel(
    SUBMODEL_WING_AREA_AERO_LOOP, "Aguglani.submodel.loop.wing_area.update.aero.simple"
)
...
@oad.RegisterSubmodel(
    SUBMODEL_WING_AREA_AERO_CONS, "Aguglani.submodel.loop.wing_area.constraint.aero.simple"
)
