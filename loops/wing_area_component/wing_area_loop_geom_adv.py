...
from Aguglani.models.geometry.geom_components.wing.components.compute_wing_l1_l4 import (
    ComputeWingL1AndL4,
)
from Aguglani.models.geometry.geom_components.wing.components.compute_wing_l2_l3 import (
    ComputeWingL2AndL3,
)
from Aguglani.models.geometry.geom_components.wing.components.compute_wing_y import (
    ComputeWingY,
)
from Aguglani.models.geometry.geom_components.wing_tank.compute_mfw_advanced import (
    ComputeMFWAdvanced,
)
...
@oad.RegisterSubmodel(
    SUBMODEL_WING_AREA_GEOM_LOOP, "Aguglani.submodel.loop.wing_area.update.geom.advanced"
)
...
@oad.RegisterSubmodel(
    ...
    "Aguglani.submodel.loop.wing_area.constraint.geom.advanced",
)
