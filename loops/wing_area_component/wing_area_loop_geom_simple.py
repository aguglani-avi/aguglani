...
oad.RegisterSubmodel.active_models[SUBMODEL_WING_AREA_GEOM_LOOP] = (
    "Aguglani.submodel.loop.wing_area.update.geom.simple"
)
oad.RegisterSubmodel.active_models[SUBMODEL_WING_AREA_GEOM_CONS] = (
    "Aguglani.submodel.loop.wing_area.constraint.geom.simple"
)


@oad.RegisterSubmodel(
    SUBMODEL_WING_AREA_GEOM_LOOP, "Aguglani.submodel.loop.wing_area.update.geom.simple"
)
...
@oad.RegisterSubmodel(
    SUBMODEL_WING_AREA_GEOM_CONS, "Aguglani.submodel.loop.wing_area.constraint.geom.simple"
)
