...
from Aguglani.models.performances.mission.takeoff import TakeOffPhase
from Aguglani.models.weight.cg.cg_variation import InFlightCGVariation


@oad.RegisterOpenMDAOSystem(
    "Aguglani.performances.mission_builder_prep", domain=ModelDomain.PERFORMANCE
)
...
class _PrepareMissionBuilder(om.ExplicitComponent):
    """
    Make some simple computation in order to enable the use of the mission builder in Aguglani-GA
