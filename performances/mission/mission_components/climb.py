...
from Aguglani.module_management._bundle_loader import BundleLoader
import Aguglani.api as oad
from Aguglani.constants import EngineSetting

from stdatm import Atmosphere

from Aguglani.models.performances.mission.takeoff import SAFETY_HEIGHT
...
oad.RegisterSubmodel.active_models[SUBMODEL_CLIMB] = (
    "Aguglani.submodel.performances.mission.climb.legacy"
)
oad.RegisterSubmodel.active_models[SUBMODEL_CLIMB_SPEED] = (
    "Aguglani.submodel.performances.mission.climb_speed.legacy"
)


@oad.RegisterSubmodel(SUBMODEL_CLIMB, "Aguglani.submodel.performances.mission.climb.legacy")
...
@oad.RegisterSubmodel(
    SUBMODEL_CLIMB_SPEED, "Aguglani.submodel.performances.mission.climb_speed.legacy"
)
