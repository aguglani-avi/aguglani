...
oad.RegisterSubmodel.active_models[SUBMODEL_DESCENT] = (
    "Aguglani.submodel.performances.mission.descent.legacy"
)
oad.RegisterSubmodel.active_models[SUBMODEL_DESCENT_SPEED] = (
    "Aguglani.submodel.performances.mission.descent_speed.legacy"
)


@oad.RegisterSubmodel(SUBMODEL_DESCENT, "Aguglani.submodel.performances.mission.descent.legacy")
...
@oad.RegisterSubmodel(
    SUBMODEL_DESCENT_SPEED, "Aguglani.submodel.performances.mission.descent_speed.legacy"
)
