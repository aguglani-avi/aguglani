...
oad.RegisterSubmodel.active_models[SUBMODEL_TAXI] = (
    "Aguglani.submodel.performances.mission.taxi.legacy"
)


@oad.RegisterSubmodel(SUBMODEL_TAXI, "Aguglani.submodel.performances.mission.taxi.legacy")
class ComputeTaxi(om.ExplicitComponent):
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        # FIXME: no specific settings for taxi (to be changed in Aguglani\constants.py)
