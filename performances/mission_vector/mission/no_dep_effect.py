"""Aguglani - Copyright (c) 2022 Aguglani."""
...
oad.RegisterSubmodel.active_models[SUBMODEL_DEP_EFFECT] = (
    "Aguglani.submodel.performances.dep_effect.none"
)


@oad.RegisterSubmodel(SUBMODEL_DEP_EFFECT, "Aguglani.submodel.performances.dep_effect.none")
