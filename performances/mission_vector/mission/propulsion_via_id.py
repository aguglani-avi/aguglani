...
from Aguglani.models.performances.mission_vector.constants import SUBMODEL_ENERGY_CONSUMPTION

oad.RegisterSubmodel.active_models[SUBMODEL_ENERGY_CONSUMPTION] = (
    "Aguglani.submodel.performances.energy_consumption.ICE"
)


@oad.RegisterSubmodel(
    SUBMODEL_ENERGY_CONSUMPTION, "Aguglani.submodel.performances.energy_consumption.ICE"
)
